...
## Type: String
c.content.headers.accept_language = 'ja'
...
## Type: FontFamily
c.fonts.web.family.sans_serif = 'IPAexGothic'

# Font family for serif fonts.
## Type: FontFamily
c.fonts.web.family.serif = 'IPAexMincho'

# Font family for standard fonts.
## Type: FontFamily
c.fonts.web.family.standard = 'IPAexGothic'
...
## Type: Dict
c.url.searchengines = {'DEFAULT': 'https://www.google.co.jp/search?q={}'}
...
config.bind('<Ctrl-J>', 'clear-keychain ;; search ;; fullscreen --leave')
...
config.bind('<Ctrl-J>', 'leave-mode', mode='caret')
...
config.bind('<Ctrl-J>', 'leave-mode', mode='command')
...
config.bind('<Ctrl-J>', 'leave-mode', mode='hint')
...
config.bind('<Ctrl-J>', 'leave-mode', mode='prompt')
...
config.bind('<Ctrl-J>', 'leave-mode', mode='register')
